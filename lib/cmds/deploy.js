    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
                ...
                index_1.default.onReceive(function (message) {
                    if (typeof message === 'string') {
                        ...
                        if (message.code === 0) {
                            ...
                            shell_messages_helper_1.runShellError(typeof message.error === 'string' ? message.error : (message.error.message || ''), true);
                        }
                    }
                });
                params = {
            ...
            case 6:
                ...
                shell_messages_helper_1.runShellError(typeof error_1 === 'string' ? error_1 : (error_1.message || ''), true);
                console.error('\n');
                process.exit();
                return [3 /*break*/, 7];
