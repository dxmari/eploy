...
var ServerHelper = /** @class */ (function () {
    ...
    ServerHelper.prototype.runDeploy = function (config, ws) {
        this.navigateToAppPathAndLaunchScript(config.cloud_config, ws);
    };
    ServerHelper.prototype.navigateToAppPathAndLaunchScript = function (cloudConfig, ws) {
    ...
    ServerHelper.prototype.runFilesExtract = function (ws, transferConfig) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filename = (transferConfig === null || transferConfig === void 0 ? void 0 : transferConfig.source_path.split('/').pop()) + '.zip';
                        return [4 /*yield*/, exec_1.default("cd " + (transferConfig === null || transferConfig === void 0 ? void 0 : transferConfig.destination_path) + " && tar -xvf " + filename + " && rm " + filename)];
                    case 1:
                        logs = _a.sent();
                        ws.send(logs);
