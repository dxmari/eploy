...
var ServerHelper = /** @class */ (function () {
    ...
    ServerHelper.prototype.handleMessage = function (serverMessage, ws) {
        ...
        if (serverMessage.type === 'deploy') {
            if (serverMessage.configType === 'staging') {
                this.runDeploy(ws, (_a = serverMessage.config.cloud_config) === null || _a === void 0 ? void 0 : _a.staging);
            }
            else {
                this.runDeploy(ws, (_b = serverMessage.config.cloud_config) === null || _b === void 0 ? void 0 : _b.production);
            }
        }
    ...
    ServerHelper.prototype.runDeploy = function (ws, cloudConfig) {
