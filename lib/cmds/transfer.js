...
exports.default = (function (args) { return __awaiter(void 0, void 0, void 0, function () {
    var filePath, config, source_path, dest_path, source_path, dest_path;
    var _a, _b, _c, _d, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                if (!(args._.length === 1)) return [3 /*break*/, 4];
                console.log('run');
                filePath = path_1.default.resolve('./eploy.config.js');
                config = require(filePath);
                source_path = ((_a = config.transfer_config) === null || _a === void 0 ? void 0 : _a.source_path) || "";
                dest_path = (_b = config.transfer_config) === null || _b === void 0 ? void 0 : _b.destination_path;
                return [4 /*yield*/, shell_1.default("tar -czvf /tmp/" + (source_path + '.zip') + " " + source_path)];
            case 1:
                _f.sent();
                console.log('\n\Folder zipping completed..');
                return [4 /*yield*/, shell_1.default("scp -rp /tmp/" + source_path.split('/').pop() + ".zip " + ((_c = config.transfer_config) === null || _c === void 0 ? void 0 : _c.user) + "@" + ((_d = config.transfer_config) === null || _d === void 0 ? void 0 : _d.host) + ":" + dest_path)];
            case 2:
                _f.sent();
                console.log('\n\nThe zip file was transfered to a server..');
                return [4 /*yield*/, index_1.default.onInit((_e = config.transfer_config) === null || _e === void 0 ? void 0 : _e.host)];
            case 3:
                _f.sent();
                index_1.default.sendParamsToServer(JSON.stringify({
                    type: 'transfer',
                    config: config
                }));
